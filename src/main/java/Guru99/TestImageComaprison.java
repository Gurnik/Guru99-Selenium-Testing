...
public class TestImageComaprison {
    ...
    public static void main(String[] args) throws IOException {
        ...
        WebElement logoElement = driver.findElement(By.xpath("//*[@id=\"rt-maintop\"]//img"));
        Screenshot logoElementScreenshot = new AShot().takeScreenshot(driver, logoElement);

        // read the image to compare

        BufferedImage expectedImage = ImageIO.read(new File(System.getProperty("user.dir") + "\\Guru99logo.png"));
